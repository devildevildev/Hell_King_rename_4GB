...
async def donatecm(bot,message):
	...
	keybord = InlineKeyboardMarkup([
        			[InlineKeyboardButton("🦋 Admin",url = "https://t.me/Developer_Devil_01"), 
        			InlineKeyboardButton("✖️ Close",callback_data = "cancel") ]])
	await message.reply_text(text = text,reply_markup = keybord)

@Client.on_message(filters.private & filters.user(Config.OWNER) & filters.command(["admin"]))
...
# Jishu Developer 
# Don't Remove Credit 🥺
# Telegram Channel @Hell_King_69_Bot
