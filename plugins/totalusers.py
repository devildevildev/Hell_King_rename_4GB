...
@Client.on_message(filters.private & filters.user(Config.OWNER)  & filters.command(["users"]))
...
@Client.on_message(filters.private & filters.user(Config.OWNER)  & filters.command(["allids"]))
