...
async def upgrade(bot,update):
	...
	**💎 Pro**
	...
	Pay Using Upi I'd `example@example`
	
	After Payment Send Screenshots Of 
        Payment To Admin @Developer_Devil_01"""
	keybord = InlineKeyboardMarkup([[InlineKeyboardButton("Admin",url = "https://t.me/Developer_Devil_01")], 
